...
<div class="header">Perpanjang Data {{ $title or '' }}</div>
<div class="content">
    <form class="ui data form" id="dataForm" action="{{ url($pageUrl.$record->id) }}" method="POST">
        ...
        <div class="field">
            ...
            <div class="ui left icon input">
                <i class="user icon"></i>
                <input type="text" placeholder="Nama Belakang" name="nama_belakang" value="{{ $record->nama_belakang }}" readonly>
            </div>
        </div>
        <div class="field">
            <label>E-Mail</label>
        ...
        @endif
         ...
         <div class="field" style="margin-top: 15px;">
            ...
            <div class="ui left icon input">
                ...
                <input class="xxxxx" type="text" placeholder="Tgl Aktif" name="aktif_awal" id="tgl_awal" value="{{ $record->aktif_akhir }}">
            </div>
        </div>
        <div class="field">
            <label>Paket</label>
