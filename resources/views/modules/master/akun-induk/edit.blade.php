	...
	<form class="ui data form" id="dataForm" action="{{ url($pageUrl.$record->id) }}" method="POST" autocomplete="off">
		...
		<div class="ui form">
			<div class="field">
				...
				<input type="text" name="password" placeholder="Password" value="{{ $record->password or '' }}">
			</div>
		</div>
		<div class="field">
            ...
            <div class="ui left icon input">
                ...
                <input class="xxxxx" type="text" placeholder="Tgl Aktif" name="aktif_awal" id="tgl_awal" value="{{ $record->aktif_awal or '' }}">
            </div>
        </div>
        <div class="field">
            <label>Paket</label>
