...
<head>
	<meta charset="utf-8" />
	<title>Syafril Store | Email</title>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        <!--<a href="#"><img src="{{  asset('img/image-logo.jpg') }}" height="20px" /></a>-->
                                                    </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <a href="#"><img src="{{ asset('img/image-logo.jpg') }}" /></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <h4>Hi {{ $data->fullname }}</h4>                                                    
                                                    <p class="last">
                                                        Paket {{ ($data->tipe == 'SPOTIFY TRIAL' ? 'SPOTIFY' : $data->tipe ) }} premium anda yang terdaftar di toko kami FRIL STORE akan berakhir pada tanggal {{ $data->aktif_akhir }}. Mohon lakukan pembayaran sebelum tanggal {{ $data->aktif_akhir }} apabila ingin melakukan perpanjangan. Kalau tidak ada kabar berarti hari H, Kami akan nonaktifkan {{ ($data->tipe == 'SPOTIFY TRIAL' ? 'SPOTIFY' : $data->tipe ) }} anda.
                                                    </p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                	...
                                                	Email 		: {{$data->email}}
                                                	<br>
                                                	Paket		: {{$data->paket}} Bulan
                                                	<br>
                                                	<br>
                                                	Apabila anda ingin melakukan perpanjangan anda bisa menghubungi kami melalui:
                                                	<br>
                                                	<br>
                                                	Line 		: @frilstore
                                                	<br>
                                                	Whatsapp	: +628122881617
                                                	<br>
                                ...
                                <tr>
                                    <td class="wrapper">
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h4>Batas pembayaran perpanjangan paket premium beserta konfirmasi buktinya sampai tanggal {{$data->aktif_akhir}} pukul 21.00 WIB. Terima Kasih.</h4>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            <table class="four columns">
                                                <tr>
                                                    <td>
                                                        &copy; Syafril Store {{Carbon\Carbon::now()->format('Y')}}.
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
